...
export function calculateGST(amount, category) {
  ...
  switch(category){
    case 'essential': gst = 0
    break;
    case 'food': gst = 5
    break;
    case 'standard': gst = 12
    break;
  ...
  let gstAmnt = parseFloat((amount*(gst/100)).toFixed(2))
  let totalamnt = amount + gstAmnt
  return {baseAmount:amount,gstRate:gst,gstAmount:gstAmnt,totalAmount:totalamnt}
}

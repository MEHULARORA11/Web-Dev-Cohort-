...
export function chaiTapriRevenue(customers) {
  // Your code here
  if(typeof(customers) !== 'number' || customers !== parseInt(customers) || customers<=0)  return {totalChai:0,totalRevenue:0}

let  adrakChai = Math.floor(customers/3)
 
  let normalChai = customers - adrakChai
  let totalChai = normalChai + adrakChai
  let totalRevenue = adrakChai*15 + normalChai*10

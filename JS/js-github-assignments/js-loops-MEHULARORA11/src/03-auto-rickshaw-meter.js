 ...
 */
export function calculateAutoFare(distance, waitingMinutes = 0) { // note this syntax of waitingMinutes ie waitingMinutes may or may not be present
  ...
  let kmBtw_2to5 
  let kmBtw_more_than5 
  if(distance-5 >= 0){
  kmBtw_2to5 = 4
  kmBtw_more_than5 = distance - 5
  }else{
    kmBtw_2to5 = distance-1
    kmBtw_more_than5 = 0
  }
 
  let fare = 30 + kmBtw_2to5*15 + kmBtw_more_than5*10 + pairs*5
  return fare

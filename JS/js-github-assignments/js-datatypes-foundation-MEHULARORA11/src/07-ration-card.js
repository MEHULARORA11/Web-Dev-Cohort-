...
export function hasRationCard(registry, cardId) {
  // Your code here
  if(typeof(registry) !== 'object' || Array.isArray(registry) || registry === null || typeof(cardId) !== 'string'){
  return false
  }
...
export function removeRationCard(registry, cardId) {
 ...
 delete registry[cardId] // note registry.cardId is wrong else it means to literally delete the property named cardId which does not exist
  return true            
}
  return false
}
